							...
							<div class="row">
								...
								<div class="span6 last info">
									...
									<div class="acf-map">
										...
										<div class="marker" data-marker="smjestaj" data-lat="<?php echo $location['lat']; ?>" data-lng="<?php echo $location['lng']; ?>"></div>
									</div>
									<?php endif; ?>
									<div class="podaci row">
										...
										<div class="span6 last tr">
											<?php if(!empty($tel)) {?> <div class="tel"><?php echo str_replace("; ","<br>", $tel); ?></div><?php } ?>
