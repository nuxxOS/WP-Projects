<div class="page-banner container-full clearfix" style="background: url(<?php the_field('banner_background'); ?>) center;">
		...
		<div id="header-yellow" class="banner-yellow container-full clearfix"></div>
			...
			<div class="banner container clearfix">
				...
				<div class="banner-title clearfix">
					<a href="<?php echo get_permalink( 11 ); ?>"><h1 class="white"> <?php
							$pageID = 11;
				...
				<div class="banner-title-icon clearfix"> 
					...
					<span class="icon-chevron-right"></span>
						<a href="<?php echo get_permalink( 11 ); ?>"><h5> <?php
								$pageID = 11;
								$page = get_post($pageID);
								echo $page->post_title;
								?> </h5></a>
